...
export function RightPanel({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-card/80 text-card-foreground" data-testid="right-panel">
      <div className="flex h-14 min-w-0 flex-none items-center gap-1 overflow-hidden border-b border-border/35 bg-card/70 px-2 backdrop-blur sm:h-12" role="tablist" aria-label={t('rightPanel.tools')}>
        <div className="ak-segmented-control grid min-w-0 flex-1 grid-cols-4 gap-0.5" data-testid="right-panel-tabs">
