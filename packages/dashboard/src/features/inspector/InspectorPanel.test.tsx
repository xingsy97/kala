...
const timeline: TimelineEntry[] = [
  {
    ...
    event: { kind: 'user_message', text: 'Fix executor relative paths so they follow cwd.' },
    ...
    llmTrace: {
      ...
      request: {
        ...
        body: {
          ...
          max_tokens: 4096,
          stream: true,
          messages: [{ role: 'user', content: [{ type: 'text', text: 'Fix executor relative paths so they follow cwd.' }] }],
        },
      },
      response: {
        status: 200,
