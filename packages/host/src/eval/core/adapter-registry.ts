...
import { programBenchAdapter } from '../programbench/programbench-adapter.js'
import { sweMarathonAdapter } from '../swe-marathon/swe-marathon-adapter.js'
...
const ADAPTERS: Readonly<Record<BenchmarkKind, AnyBenchmarkAdapter>> = {
  ...
  'program-bench': programBenchAdapter as unknown as AnyBenchmarkAdapter,
  'swe-marathon': sweMarathonAdapter as unknown as AnyBenchmarkAdapter,
}
