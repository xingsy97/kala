...
async function setup() {
  ...
  const store = new RuntimeUnitMaterializationStore(join(root, 'catalog.json')); attachTenantRuntimeControlApi({ http, serviceSecret: 'secret', service, store, dataRoot: root })
