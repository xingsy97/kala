...
1. **Tool registry** (`src/tools/`)  -  one file per tool from [`docs/executor/tools.md`](../../docs/executor/tools.md): `read`, `ls`, `glob`, `grep`, `write`, `edit`, `bash`, `todowrite`, `web_search`, `bash_output`, `kill_shell`.
