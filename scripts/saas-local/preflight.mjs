...
const secretDir = resolve(root, process.env.RUNLAB_SECRETS_DIR ?? 'deploy/saas/.secrets')
...
const providerPath = resolve(root, process.env.RUNLAB_PROVIDER_CATALOG_FILE ?? 'deploy/saas/local/runtime-provider-catalog.json')
