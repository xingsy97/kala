...
const calibrationRoot = path.join(legacy-runnerRoot, 'diagnostics/swe-marathon/no-run-calibration')
const referenceRoot = path.join(legacy-runnerRoot, 'references/swe-marathon')
