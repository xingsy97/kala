...
const reference = path.join(portfolio, 'references/swe-marathon')
const planningDir = path.join(portfolio, 'planning/swe-marathon')
const diagnosticsDir = path.join(portfolio, 'diagnostics/swe-marathon')
const reportDir = path.join(portfolio, 'reports/swe-marathon')
