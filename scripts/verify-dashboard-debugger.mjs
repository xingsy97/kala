...
function writeFixture() {
  ...
  const entries = [
    ...
    { kind: 'event', seq: 1, ts: '2026-07-06T06:00:01.000Z', event: { kind: 'user_message', text: 'Fix executor relative paths so they follow cwd.' }, effects: [{ kind: 'call_llm', messages: initialState.messages, tools: config.tools }] },
