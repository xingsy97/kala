...
- **No new `docs/capabilities/13-XX.md`**: 12 capability documents is already the ceiling. Additional design documents dilute the signal — readers open the code, not more markdown.
