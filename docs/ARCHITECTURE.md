...
- Host handles manual/auto compaction by summarizing with the LLM and recording `compact_replaced`; dashboard manual compaction is available from the Composer compact button and exact `/compact` command.
