# authoring-notes  -  index

This file is an index into the substantive documents.

## Hard constraints (read before starting)

- [principles.md](principles.md)  -  design and implementation principles; each maps to a lint, test, or e2e enforcement
- [past-mistakes.md](past-mistakes.md)  -  list of historical mistakes; append new ones as they occur
...
- [domain-knowledge/](../evals/domain-knowledge)  -  official semantics for each benchmark
