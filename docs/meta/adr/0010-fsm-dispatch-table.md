...
- We give up "XState on the resume" as a legibility signal. Trade: "hand-rolled a finite state machine that mirrors the spec" is a more implementation-quality signal than "used a state machine library."
