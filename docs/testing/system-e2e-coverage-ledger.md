...
| Interactive Terminal | `scripts/product-e2e/verify-core-workspace-journeys.mjs` | Resize/kill and terminal-specific reconnect cleanup remain | Complete (input/output); Partial (lifecycle) | Real Chromium keyboard → PTY echo/resize/kill/reconnect cleanup |
