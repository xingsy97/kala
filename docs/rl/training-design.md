...
- projected or actual spend would exceed the the configured budget cap;
- spend reaches 25 USD without passing strict preflight on a selected host;
...
- a cleanup line showing `vastai show instances --raw` returns `[]`.
