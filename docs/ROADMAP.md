...
- Composer footer now owns the model picker, host status, context usage ring, compact button, and send button. Runtime cursor/pending/token details live in `ActivityBar`.
