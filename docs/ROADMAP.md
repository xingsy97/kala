...
## Phase 0  -  Learning & spec ð - 

**Purpose**: Ground the design in the actual state of the art. Avoid inventing things existing projects already handle well.

**Deliverables**:
- ð -  Clone and read the reference projects: [pi](https://github.com/earendil-works/pi), [opencode](https://github.com/sst/opencode), [codex](https://github.com/openai/codex), [Claude Code source-collection](https://github.com/chauncygu/collection-claude-code-source-code)
- ð -  Quantitative comparison: `docs/references-comparison.md` (~2800 words, 10 kernel design lessons)
